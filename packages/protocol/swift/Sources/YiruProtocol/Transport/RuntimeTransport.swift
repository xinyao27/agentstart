...
public let yiruRuntimeProtocolVersion = UInt32(Yiru_Protocol_V1_ProtocolVersion.v2.rawValue)
public let yiruRuntimeDefaultTimeout: Duration = .seconds(30)
public let yiruRuntimeInitialCallCreditBytes = 1024 * 1024
public let yiruRuntimeMaxFrameBytes = 1024 * 1024
public let yiruRuntimeMaxPendingCalls = 128
public let yiruRuntimeMaxPendingResponseBytes = 8 * 1024 * 1024
public let yiruRuntimeMaxPendingRequestBytes = 8 * 1024 * 1024
public let yiruRuntimeWirePreambleBytes = 5
