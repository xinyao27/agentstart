...
public enum RuntimeFrameCodec {
  public static let preamble = Data([0x59, 0x49, 0x52, 0x55])
  public static let preambleByteCount = yiruRuntimeWirePreambleBytes
  public static let versionByte = UInt8(Yiru_Protocol_V1_ProtocolVersion.v2.rawValue)
  ...
  public static func encode(
    _ frame: Yiru_Protocol_V1_Frame,
    maxFrameBytes: Int
  ) throws -> Data {
  ...
  public static func decode(
    ...
    let frame = try Yiru_Protocol_V1_Frame(serializedBytes: message)
    guard frame.protocolVersion == yiruRuntimeProtocolVersion, frame.body != nil else {
      throw RuntimeTransportError.unexpectedMessage
    }
    return frame
  }
