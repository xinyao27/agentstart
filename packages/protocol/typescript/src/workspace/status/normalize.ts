...
import { DEFAULT_STATUS_VISUALS, DEFAULT_WORKSPACE_STATUSES } from './defaults.js'
import {
  isKnownBadPRReorderedDefaultStatusPayload,
  isLegacyDefaultWorkflowStatusPayload
} from './migration.js'
import type { WorkspaceStatus, WorkspaceStatusDefinition } from './model.js'
...
function makeWorkspaceStatusId(
  label: string,
