...
export function buildPullRequestFieldsPrompt(
  ...
  const base = [
    ...
    '- If Current description contains a pull request template, preserve its headings, required sections, and checklists while filling relevant sections from the branch changes.',
