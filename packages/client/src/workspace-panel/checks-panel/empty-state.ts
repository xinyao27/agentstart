...
export function getChecksPanelEmptyStateCopy(
  ...
  if (input.operationLabel) {
    return {
      title: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.d77c513c1e',
        '{{value0}} in progress',
        { value0: input.operationLabel }
      ),
      description: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.05e4aec17b',
  ...
  if (input.hasAmbiguousGitHubHostedReview === true) {
    if (input.prRefreshStatus === 'error') {
      return {
        title: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.5f478ab3d3',
          'Could not refresh pull request'
        ),
        description: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.2bdd7aaf2d',
    ...
    return {
      title: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.3322603418',
        'Pull request status unavailable'
      ),
      description: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.b597440265',
  ...
  if (
    ...
    return {
      title: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.41252bc53f',
        'Branch not published'
      ),
      description: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.f8543140cc',
  ...
  if (blockedReason === 'needs_push') {
    return {
      title: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.76e15946a9',
        'Branch has unpushed commits'
      ),
      description: translate(
        'auto.components.workspacePanel.checks.panel.empty.state.6ce9d4e069',
  ...
  switch (input.prRefreshStatus) {
    ...
    case 'queued':
      return {
        title: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.938b5606a6',
          'Checking for pull request'
        ),
        description: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.6ba2440770',
    ...
    case 'in-flight':
      return {
        ...
        description: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.3d4af82ff4',
    ...
    case 'paused':
      return {
        title: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.7c299df37b',
          'No pull request found'
        ),
        description: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.d372072df1',
    ...
    case undefined:
      return {
        title: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.13e1c7d5ed',
          'No {{value0}} found',
          { value0: 'pull request' }
        ),
        description: translate(
          'auto.components.workspacePanel.checks.panel.empty.state.5b0cfae9a5',
