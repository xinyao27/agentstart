...
import { SECTION_LABELS } from '~renderer/workspace-panel/source-control/panel-constants'
import type { SourceControlDisplaySection } from '~renderer/workspace-panel/source-control/tree/section-order'
