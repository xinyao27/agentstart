...
import { SOURCE_CONTROL_PANEL_GUTTER_CLASS_NAME } from '~renderer/workspace-panel/source-control/panel-constants'
import { WORKSPACE_PANEL_BUTTON_SURFACE_CLASS_NAME } from '~renderer/workspace-panel/workspace-panel-button-styles'
...
export function SourceControlHeaderToolbar({
  ...
  return (
    <div className={cn('pt-1.5 pb-1', SOURCE_CONTROL_PANEL_GUTTER_CLASS_NAME)}>
      <div
