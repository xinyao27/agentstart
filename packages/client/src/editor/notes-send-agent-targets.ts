 ...
 * PTY. TerminalTab.launchAgent records the harness AgentStart started; manually typed
...
function deriveTitleHintAgentTarget(
  ...
  if (!titleEvidence) {
    // Why: launchAgent is set the instant AgentStart spawns the tab, but the runtime
