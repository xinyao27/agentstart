...
export function getAgentAwakeDescription(
  ...
  return translate(
    ...
    'Keeps this computer and display awake while agents are working. AgentStart also asks this device to stay awake when the lid is closed, subject to its power policy.'
  )
}
