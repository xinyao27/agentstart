...
const getEnableNotificationsEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
const getAgentTaskCompleteEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
const getTerminalBellEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
...
const getSuppressWhileFocusedEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
const getNotificationSoundEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
const getNotificationVolumeEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
const getSendTestNotificationEntry = createLocalizedCatalog((): SettingsSearchEntry => ({
  title: translate(
...
// Why: the pane groups its rows into accordion cards, so search visibility is
// decided per card from the union of its rows' entries.
export const getNotificationDeliverySearchEntries = createLocalizedCatalog(() => [
  getEnableNotificationsEntry(),
  getSuppressWhileFocusedEntry(),
  getSendTestNotificationEntry()
])

export const getNotificationEventsSearchEntries = createLocalizedCatalog(() => [
  getAgentTaskCompleteEntry(),
  getTerminalBellEntry()
])

export const getNotificationSoundSearchEntries = createLocalizedCatalog(() => [
  getNotificationSoundEntry(),
  getNotificationVolumeEntry()
])
