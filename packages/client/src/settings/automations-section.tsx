import type { RitualRunResult } from '@agentstart/protocol'
...
import { getExtensionBrowserCapabilities } from '../extension/browser-capabilities'
import { projectsQuery, WORKSPACE_EVENTS_QUERY_ROOT } from '../extension/runtime/queries'
import { RitualScheduleSettings } from './automations-schedule'

const LOCAL_DAEMON_TARGET = { kind: 'local' } as const

export function AutomationsSection(): React.JSX.Element {
