#!/usr/bin/env python3
"""AgentStart Linux computer-use bridge.

The Node sidecar owns AgentStart's public API. This process is intentionally a small
...
def handshake_response():
    ...
    return {
        "platform": "linux",
        "provider": "agentstart-computer-use-linux",
