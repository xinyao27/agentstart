...
nonisolated func hostedReviewProvider(_ value: AgentStart_Runtime_V1_GitHubHostedReviewProvider)
...
nonisolated func hostedReviewProviderValue(_ provider: HostedReviewProvider)
    -> AgentStart_Runtime_V1_GitHubHostedReviewProvider
{
    provider == .github ? .github : .unsupported
}

nonisolated func hostedReviewBlockedReason(
    _ value: AgentStart_Runtime_V1_GitHubHostedReviewBlockedReason
...
nonisolated func hostedReviewSummary(_ pr: AgentStart_Runtime_V1_GitHubPrSummary) -> HostedReview {
    HostedReview(
        provider: .github,
...
nonisolated private func hostedReviewState(_ value: AgentStart_Runtime_V1_GitHubPrState)
    -> HostedReviewState
{
    switch value {
    case .closed: .closed
...
nonisolated private func hostedReviewChecksStatus(_ value: AgentStart_Runtime_V1_GitHubChecksState)
...
nonisolated private func hostedReviewMergeable(_ value: AgentStart_Runtime_V1_GitHubPrMergeable)
...
nonisolated private func hostedReviewDecision(_ value: AgentStart_Runtime_V1_GitHubReviewDecision)
...
nonisolated private func hostedReviewMergeMethodSettings(
    _ value: AgentStart_Runtime_V1_GitHubMergeMethodSettings
...
nonisolated private func hostedReviewConflict(_ value: AgentStart_Runtime_V1_GitHubConflictSummary)
...
nonisolated func mapHostedReviewDetails(
    _ details: AgentStart_Runtime_V1_GitHubWorkItemDetails,
...
nonisolated func hostedReviewComment(
    _ comment: AgentStart_Runtime_V1_GitHubComment,
    botAuthors: Set<String>
)
    -> HostedReviewComment
{
...
nonisolated func hostedReviewReaction(
    content: AgentStart_Runtime_V1_GitHubReactionContent,
    count: UInt64
...
nonisolated func hostedReviewCheck(_ entry: AgentStart_Runtime_V1_GitHubCheckEntry)
    -> HostedReviewCheck
{
    HostedReviewCheck(
        name: entry.name,
...
nonisolated func hostedReviewCheckRunStatus(
    _ status: AgentStart_Runtime_V1_GitHubCheckRunStatus
...
nonisolated func hostedReviewCheckConclusion(
    _ conclusion: AgentStart_Runtime_V1_GitHubCheckConclusion
) -> String? {
    switch conclusion {
    case .success: "success"
    case .failure: "failure"
...
nonisolated func hostedReviewFile(_ entry: AgentStart_Runtime_V1_GitHubFileEntry)
    -> HostedReviewFile
{
    HostedReviewFile(
        path: entry.path,
...
nonisolated func hostedReviewFileStatus(_ status: AgentStart_Runtime_V1_GitHubFileStatus) -> String
{
    switch status {
    case .added: "added"
...
nonisolated func hostedReviewCheckRunDetails(_ details: AgentStart_Runtime_V1_GitHubCheckDetails)
