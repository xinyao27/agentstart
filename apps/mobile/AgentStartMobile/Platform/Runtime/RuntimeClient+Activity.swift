...
nonisolated private func mapActivityStats(
    _ response: AgentStart_Runtime_V1_GetSummaryResponse,
...
) -> AgentStart_Runtime_V1_StatsUsageRange {
    switch range {
...
nonisolated private func activityRange(
    _ range: AgentStart_Runtime_V1_StatsUsageRange,
...
nonisolated private func mapActivityProvider(
    _ usage: AgentStart_Runtime_V1_StatsProviderUsage
...
nonisolated private func activityProvider(
    _ provider: AgentStart_Runtime_V1_StatsUsageProvider
) throws -> String? {
    switch provider {
    case .claude: "claude"
    case .codex: "codex"
...
nonisolated private func mapActivityModel(
    _ usage: AgentStart_Runtime_V1_StatsModelUsage
...
nonisolated private func mapActivityProject(
    _ usage: AgentStart_Runtime_V1_StatsProjectUsage
) throws -> ActivityBreakdown {
    ActivityBreakdown(
        id: usage.key,
        label: usage.label,
...
nonisolated private func mapActivitySupplementalDaily(
    _ usage: AgentStart_Runtime_V1_StatsSupplementalDailyUsage
...
nonisolated private func activityUnavailableAgent(
    _ agent: AgentStart_Runtime_V1_StatsUnavailableAgent
) throws -> String? {
    switch agent {
