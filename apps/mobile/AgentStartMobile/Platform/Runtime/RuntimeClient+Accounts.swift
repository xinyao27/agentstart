...
extension RuntimeClient: AccountsRepository {
    ...
    func selectAccount(
        ...
        let protocolProvider: AgentStart_Runtime_V1_AccountProvider
        switch provider {
...
nonisolated private func mapAccountsSnapshot(
    _ snapshot: AgentStart_Runtime_V1_AccountsSnapshot
...
nonisolated private func mapAccountRoster(
    _ roster: AgentStart_Runtime_V1_AccountRoster,
    provider: AccountProvider
...
nonisolated private func protocolUsage(
    _ state: AgentStart_Runtime_V1_AccountRateLimitState,
    provider: AccountProvider
) -> AgentStart_Runtime_V1_ProviderRateLimits? {
    switch provider {
...
nonisolated private func mapProviderUsage(
    _ limits: AgentStart_Runtime_V1_ProviderRateLimits,
    ...
    if !limits.buckets.isEmpty {
        ...
        let candidates:
            [(
                Bool, AgentStart_Runtime_V1_RateLimitWindow, String, String, String
            )] = [
...
nonisolated private func mapWindow(
    _ window: AgentStart_Runtime_V1_RateLimitWindow,
    id: String,
    label: String,
    compactLabel: String
...
nonisolated private func mapInactiveUsage(
    _ inactive: AgentStart_Runtime_V1_InactiveAccountUsage,
    expectedProvider: AccountProvider
...
nonisolated private func accountProvider(
    _ provider: AgentStart_Runtime_V1_AccountProvider
...
nonisolated private func usageStatus(
    _ status: AgentStart_Runtime_V1_AccountUsageStatus
