...
extension RuntimeClient {
    func sessionTabsSnapshot(
        ...
        var request = AgentStart_Runtime_V1_SessionTabsServiceListRequest()
        request.worktree = worktreeSelector
        let response = try await protocolUnary(
            hostID: hostID,
            procedure: AgentStartRuntimeV1SessionTabsServiceMethods.list,
            request: request,
            response: AgentStart_Runtime_V1_SessionTabsSnapshot.self
        )
    ...
    func sessionTabsAllSnapshots(hostID: String) async throws -> [MobileSessionTabsWire] {
        let response = try await protocolUnary(
            hostID: hostID,
            procedure: AgentStartRuntimeV1SessionTabsServiceMethods.listAll,
            request: AgentStart_Runtime_V1_SessionTabsServiceListAllRequest(),
            response: AgentStart_Runtime_V1_SessionTabsServiceListAllResponse.self
        )
    ...
    func sessionTabsActivate(
        ...
        var request = AgentStart_Runtime_V1_SessionTabsServiceActivateRequest()
        request.worktree = worktreeSelector
        request.tabID = tabID
        if let leafID {
        ...
        let response = try await protocolUnary(
            hostID: hostID,
            procedure: AgentStartRuntimeV1SessionTabsServiceMethods.activate,
            request: request,
            response: AgentStart_Runtime_V1_SessionTabsSnapshot.self
        )
        return sessionTabsWire(response)
    ...
    func sessionTabsClose(
        ...
        var request = AgentStart_Runtime_V1_SessionTabsServiceTabRequest()
        request.worktree = worktreeSelector
        request.tabID = tabID
        let response = try await protocolUnary(
            hostID: hostID,
            procedure: AgentStartRuntimeV1SessionTabsServiceMethods.close,
            request: request,
            response: AgentStart_Runtime_V1_SessionTabsServiceClosedResponse.self
        )
    ...
    func sessionTabsCreateTerminal(
        ...
        var request = AgentStart_Runtime_V1_SessionTabsServiceCreateTerminalRequest()
        ...
        if let launchConfig = wire.launchConfig {
            var config = AgentStart_Runtime_V1_SessionTabsLaunchConfig()
        ...
        case "fast":
            var delivery = AgentStart_Runtime_V1_SessionTabsStartupCommandDelivery()
        ...
        let response = try await protocolUnary(
            hostID: hostID,
            procedure: AgentStartRuntimeV1SessionTabsServiceMethods.createTerminal,
            request: request,
            response: AgentStart_Runtime_V1_SessionTabsServiceCreateTerminalResponse.self
        )
...
nonisolated private func sessionTabsWire(
    _ snapshot: AgentStart_Runtime_V1_SessionTabsSnapshot
...
nonisolated private func sessionTabWire(
    _ tab: AgentStart_Runtime_V1_SessionTabsTab
...
nonisolated private func sessionAgentStatusWire(
    _ status: AgentStart_Runtime_V1_SessionTabsAgentStatus
...
nonisolated private func sessionProviderSessionWire(
    _ session: AgentStart_Runtime_V1_AgentProviderSession
...
nonisolated private func sessionTabTypeWire(
    _ type: AgentStart_Runtime_V1_SessionTabsTabType
...
nonisolated private func sessionAgentStateWire(
    _ state: AgentStart_Runtime_V1_AgentStatusState
) -> String {
    switch state {
...
nonisolated private func sessionFileModeWire(
    _ mode: AgentStart_Runtime_V1_SessionTabsFileMode
) -> String? {
    switch mode {
...
nonisolated private func sessionFileDiffSourceWire(
    _ source: AgentStart_Runtime_V1_SessionTabsFileDiffSource
) -> String? {
    switch source {
