...
actor RuntimeProtocolAdapter: RuntimeTransport {
    ...
    var negotiatedCallCreditBytes = agentstartRuntimeInitialCallCreditBytes
    var negotiatedMaxFrameBytes = agentstartRuntimeMaxFrameBytes
    ...
    var pendingWelcome: AgentStart_Protocol_V1_Welcome?
    var locallyCancelledCalls = LocallyCancelledCalls(limit: runtimeProtocolCancelledCallLimit)
    var welcome: AgentStart_Protocol_V1_Welcome?
                ...
                Task {
                    do {
                        try await self.startCall(
                            callID: callID,
                            call: call,
                            defaultTimeout: agentstartRuntimeDefaultTimeout
                        )
                    } catch {
